...
export const LandingPage: React.FC<LandingPageProps> = ({ onNavigate }) => {
    return (
        ...
        >
            ...
            >
                Experience the power of local AI with <strong>EXAONE 4.0</strong> and <strong>Qwen 3</strong> - 
                cutting-edge language models running entirely in your browser using WebGPU and WebAssembly.
            </Paragraph>
